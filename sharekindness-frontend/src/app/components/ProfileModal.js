...
const ProfileModal = ({ isOpen, onClose }) => {
  const [formData, setFormData] = useState({
    profile_picture: "/default-profile.jpg", // Example placeholder
    username: "JohnDoe",
      ...
      >
        ...
        <div className="p-4 sm:p-6 flex flex-col sm:flex-row sm:space-x-6">
                ...
                >
                  ...
                  >
                    <path
                      ...
                      d="M16.862 4.487A9.995 9.995 0 003.661 11.8M3 3l3.593 3.593m13.319 13.319A9.995 9.995 0 0111.661 3.8M21 21l-3.594-3.594"
                    />
                  </svg>
                  <input
                    id="profile_picture"
          ...
          <div className="sm:w-2/3 mt-6 sm:mt-0">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              {isEditing ? (
                ...
                <>
                  ...
                  {/* More Options -> to reveal Delete Account */}
                  <button
            ...
            {/* Delete Account (hidden behind “More Options”) */}
            {showDeleteConfirmation && !isEditing && (
              <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-md">
                <p className="text-red-500 text-sm mb-3">
                  If you really need to delete your account, click below.
                </p>
                <button
